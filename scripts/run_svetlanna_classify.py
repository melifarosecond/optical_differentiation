...
from optical_differentiation.svetlanna_model import SvetlannaOpticalModelEconomical, SvetlannaOpticalModelMultiChannel
from optical_differentiation.svetlanna_train import train_loop, test_loop
MODELS = {'single': SvetlannaOpticalModelEconomical, 'multi': SvetlannaOpticalModelMultiChannel}
...
def main():
    ...
    parser.add_argument('--batch-size', type=int, default=None, help='Если не задан — берётся разумное значение по умолчанию для модели')
